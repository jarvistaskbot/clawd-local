...
def test_stop_command_sends_message():
    ...
    with patch("main.os._exit") as mock_exit:
        asyncio.get_event_loop().run_until_complete(main.stop_command(update, context))
...
def test_restart_command_sends_message():
    ...
    with patch("main.os.execv") as mock_execv:
        asyncio.get_event_loop().run_until_complete(main.restart_command(update, context))
